import{_ as s,o as n,c as a,Q as p}from"./chunks/framework.88002d8f.js";const h=JSON.parse('{"title":"NPM","description":"","frontmatter":{},"headers":[],"relativePath":"npm/base/index.md","filePath":"npm/base/index.md"}'),l={name:"npm/base/index.md"},e=p(`<h1 id="npm" tabindex="-1">NPM <a class="header-anchor" href="#npm" aria-label="Permalink to &quot;NPM&quot;">​</a></h1><h2 id="node模块、常用命令、semver规范" tabindex="-1">Node模块、常用命令、SEMVER规范 <a class="header-anchor" href="#node模块、常用命令、semver规范" aria-label="Permalink to &quot;Node模块、常用命令、SEMVER规范&quot;">​</a></h2><p>Node模块（mode_modules）</p><p>Node环境：一个在Node环境下开发的项目，模块可能是一个库、框架或者是项目依赖、甚至是一个项目，Node环境就是让这些模块成功运行起来的服务提供方。</p><p>package.json：描述node模块的文件，包含多项对Node模块的说明与配置。</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">npm init </span></span>
