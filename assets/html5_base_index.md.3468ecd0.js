import{_ as n,o as e,c as o,Q as t}from"./chunks/framework.88002d8f.js";const g=JSON.parse('{"title":"HTML5","description":"","frontmatter":{},"headers":[],"relativePath":"html5/base/index.md","filePath":"html5/base/index.md"}'),a={name:"html5/base/index.md"},i=t(`<h1 id="html5" tabindex="-1">HTML5 <a class="header-anchor" href="#html5" aria-label="Permalink to &quot;HTML5&quot;">​</a></h1><h2 id="localstorage、sessionstorage、cookie" tabindex="-1">localStorage、sessionStorage、cookie <a class="header-anchor" href="#localstorage、sessionstorage、cookie" aria-label="Permalink to &quot;localStorage、sessionStorage、cookie&quot;">​</a></h2><pre><code>          Cookie       LocalStorage   SessionStorage
...
</code></pre><h2 id="cookie增删改查、用户追踪" tabindex="-1">cookie增删改查、用户追踪 <a class="header-anchor" href="#cookie增删改查、用户追踪" aria-label="Permalink to &quot;cookie增删改查、用户追踪&quot;">​</a></h2><pre><code>HTTP协议无状态的。 stateless。
...
</code></pre><h2 id="history、worker" tabindex="-1">history、worker <a class="header-anchor" href="#history、worker" aria-label="Permalink to &quot;history、worker&quot;">​</a></h2><pre><code>history
...
</code></pre><h2 id="获取当前位置、设备速度、设备方向" tabindex="-1">获取当前位置、设备速度、设备方向 <a class="header-anchor" href="#获取当前位置、设备速度、设备方向" aria-label="Permalink to &quot;获取当前位置、设备速度、设备方向&quot;">​</a></h2><pre><code>geolocation 地理位置
...
设备方向  deviceorientation
...
</code></pre><h2 id="touchstart、touchmove、touchend" tabindex="-1">touchstart、touchmove、touchend <a class="header-anchor" href="#touchstart、touchmove、touchend" aria-label="Permalink to &quot;touchstart、touchmove、touchend&quot;">​</a></h2><pre><code>移动端事件处理
  ...
  事件属性
    ...
    一般都是多点触控时用的属性
</code></pre>`,11),r=[i];function c(s,l,h,d,k,u){return e(),o("div",null,r)}const p=n(a,[["render",c]]);export{g as __pageData,p as default};
