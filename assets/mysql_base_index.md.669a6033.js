...
<span class="line"><span style="color:#24292e;">-&gt; DELIMITER ; -- 恢复分隔符为；</span></span></code></pre></div><p>这样，我们的存储过程就创建成功了。</p><p>在这个存储过程中，我们用到了存储过程的参数定义和程序体，这些具体是什么意思呢？我们来学习下。</p><h3 id="存储过程的参数定义" tabindex="-1">存储过程的参数定义 <a class="header-anchor" href="#存储过程的参数定义" aria-label="Permalink to &quot;存储过程的参数定义&quot;">​</a></h3>`,1158),k=[O];function M(I,D,U,F,f,_){return n(),a("div",null,k)}const B=s(C,[["render",M]]);export{w as __pageData,B as default};
