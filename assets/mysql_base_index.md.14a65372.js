...
<span class="line"><span style="color:#24292e;">+------------+---------+-----------+------------+</span></span>
<span class="line"><span style="color:#24292e;">3 rows in set (0.00 sec)</span></span></code></pre></div><h4 id="修改视图数据" tabindex="-1">修改视图数据 <a class="header-anchor" href="#修改视图数据" aria-label="Permalink to &quot;修改视图数据&quot;">​</a></h4><p>我们可以通过 UPDATE 语句对视图中的数据进行修改：</p><div class="language-mysql vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">mysql</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;"></span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;"></span></span></code></pre></div>`,1091),k=[O];function M(I,D,U,F,_,f){return n(),a("div",null,k)}const w=s(C,[["render",M]]);export{B as __pageData,w as default};
