import{_ as s,o as a,c as n,Q as e}from"./chunks/framework.9bc09dc8.js";const p="/assets/type.7da76259.png",l="/assets/type02.7a662d7a.png",o="/assets/type03.1e016f4e.png",c="/assets/table02.4a53e957.png",t="/assets/table03.13f6828b.png",i="/assets/table06.ea10e1b0.png",r="/assets/table07.fe469480.png",y="/assets/table08.5dc9f071.png",d="/assets/table09.96d5a223.png",m="/assets/table10.cc69f1be.png",E="/assets/table11.2daba66a.png",h="/assets/table12.83448c9a.png",g="/assets/table13.90726171.png",u="/assets/table14.cacb5cb4.png",b="/assets/table15.95e3ec35.png",F=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"mysql/base/index.md","filePath":"mysql/base/index.md"}'),L={name:"mysql/base/index.md"},v=e(`<p>MySQL 必知必会</p><p>安装数据库</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">docker</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">run</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">-d</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">-p</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">3306</span><span style="color:#9ECBFF;">:3306</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">\\d</span></span>
...
<span class="line"><span style="color:#24292e;">    demo.importheadhist CHANGE quantity importquantity DOUBLE;</span></span></code></pre></div><p>运行 SQL 语句后，重新查看表结构，可以得到下面的结果：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">mysql&gt; DESCRIBE demo.importheadhist;</span></span>
<span class="line"><span style="color:#e1e4e8;">+----------------+---------------+------+-----+---------+-------+</span></span>
<span class="line"><span style="color:#e1e4e8;">| Field          | Type          | Null | Key | Default | Extra |</span></span>
<span class="line"><span style="color:#e1e4e8;">+----------------+---------------+------+-----+---------+-------+</span></span>
<span class="line"><span style="color:#e1e4e8;">| listnumber     | int           | NO   |     | NULL    |       |</span></span>
...
<span class="line"><span style="color:#24292e;">ADD</span></span>
<span class="line"><span style="color:#24292e;">    suppliername TEXT AFTER supplierid;</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">mysql&gt; DESCRIBE demo.importheadhist;</span></span>
<span class="line"><span style="color:#e1e4e8;">+----------------+---------------+------+-----+---------+-------+</span></span>
<span class="line"><span style="color:#e1e4e8;">| Field          | Type          | Null | Key | Default | Extra |</span></span>
<span class="line"><span style="color:#e1e4e8;">+----------------+---------------+------+-----+---------+-------+</span></span>
<span class="line"><span style="color:#e1e4e8;">| listnumber     | int           | NO   |     | NULL    |       |</span></span>
...
<span class="line"><span style="color:#24292e;">);</span></span></code></pre></div><p>如果我们不控制查询结果顺序，就会得到这样的结果：</p><div class="language-mysql vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">mysql</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">SELECT * FROM demo.goodsmater;</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">SELECT * FROM demo.goodsmater;</span></span></code></pre></div><div><img src="`+r+'"></div><p>如果我们使用 ORDER BY 对查询结果进行控制，结果就不同了：</p><div class="language-mysql vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">mysql</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">SELECT * FROM demo.goodsmater ORDER BY barcode ASC, price DESC;</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">SELECT * FROM demo.goodsmater ORDER BY barcode ASC, price DESC;</span></span></code></pre></div><div><img src="'+y+'"></div><p>可以看到，查询结果会先按照字段 barcode 的升序排序，相同 barcode，再按照 price 的降序排序。</p><h4 id="limit" tabindex="-1">LIMIT <a class="header-anchor" href="#limit" aria-label="Permalink to &quot;LIMIT&quot;">​</a></h4><p>LIMIT 作用是告诉 MySQL 只显示部分查询结果。</p><p>比如，在我们的数据表 demo.goodsmaster 中有 4 条数据，我们只想显示第 2、3 条数据，就可以使用 LIMIT 关键字来实现。</p><div class="language-mysql vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">mysql</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">SELECT * FROM demo.goodsmater LIMIT 1,2;</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">SELECT * FROM demo.goodsmater LIMIT 1,2;</span></span></code></pre></div><div><img src="'+d+`"></div><h3 id="总结" tabindex="-1">总结 <a class="header-anchor" href="#总结" aria-label="Permalink to &quot;总结&quot;">​</a></h3><p>本篇文章，我们学习了添加、删除、修改和查询数据的方法，这些都是我们经常遇到的操作。</p><div class="language-mysql vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">mysql</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">INSERT INTO 表名 [(字段名 [,字段名] ...)] VALUES (值的列表);</span></span>
<span class="line"><span style="color:#e1e4e8;"></span></span>
...
<span class="line"><span style="color:#24292e;">);</span></span></code></pre></div><p>插入成功后，我们再来看下表的内容：</p><div class="language-mysql vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">mysql</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">SELECT * FROM demo.membermaster;</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">SELECT * FROM demo.membermaster;</span></span></code></pre></div><div><img src="`+h+'"></div><p>我们可以发现，不同的会员卡号对应不同的会员，字段 ”cardno“ 唯一地标识某一个会员。如果都是这样，会员卡号与会员一一对应，系统是可以正常运行的。</p><p>但是实际情况并没有这么简单，会员卡号存在重复使用的情况。比如，张三因为工作变动搬离原来的地址，不再到商家的门店消费（退还会员卡），于是张三就不再是这个商店门店的会员了。但是，商家不想让这个会员卡空着，就把卡号是 ”10000001“ 的会员卡发给王五。</p><p>从系统设计的角度来看，这个变化只是修改会员信息表中的卡号为 ”10000001“ 的会员信息，但不会影响到数据一致性。也就是说，修改会员卡号是 ”10000001“ 的会员信息，系统的各个模块都会获取到修改后的会员信息。因此，从信息系统层面上看是没有问题的。但是从使用系统的业务层面来看，就有很大的问题了，会对商家造成影响。</p><p>下面，我们就来看看这种修改，是如何影响到商家的。</p><p>比如，我们有一个销售流水表，记录了所有的销售流水明细。2020 年 12 月 01 日，张三在门店购买一本书，消费 89 元。那么，系统中就有了张三买书的记录，如下所示：</p><img src="'+g+`"><p>我们可以用下面的代码创建销售流水表。因为需要引用会员信息和商品信息，所以表中要包括商品编号字段和会员卡号字段。</p><div class="language-mysql vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">mysql</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">CREATE TABLE demo.trans</span></span>
<span class="line"><span style="color:#e1e4e8;">(</span></span>
...
<span class="line"><span style="color:#24292e;">ON (a.cardno = b.cardno AND a.itemnumber = c.itemnumber);</span></span></code></pre></div><div><img src="`+u+`"></div><p>我们用到了 JOIN，也就是表的关联，目的就是为了引用其他表的信息，包括会员信息表（demo.membermaster）和商品信息表（demo.goodsmater）。通过关联查询，我们就可以从会员信息表中获取会员信息，从商品信息表获取商品信息。</p><p>下面，我们假设会员卡 ”10000001“ 又发给王五，我们需要更改会员信息表。</p><div class="language-mysql vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">mysql</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">UPDATE demo.membermaster</span></span>
