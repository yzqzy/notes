import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.88002d8f.js";const C=JSON.parse('{"title":"Electron","description":"","frontmatter":{},"headers":[],"relativePath":"electron/base/index.md","filePath":"electron/base/index.md"}'),p={name:"electron/base/index.md"},o=l(`<h1 id="electron" tabindex="-1">Electron <a class="header-anchor" href="#electron" aria-label="Permalink to &quot;Electron&quot;">​</a></h1><h2 id="electron-技术架构" tabindex="-1">Electron 技术架构 <a class="header-anchor" href="#electron-技术架构" aria-label="Permalink to &quot;Electron 技术架构&quot;">​</a></h2><p>Electron 由 Chromium、Node.js、Native apis 构成。</p><h3 id="chromium" tabindex="-1">Chromium <a class="header-anchor" href="#chromium" aria-label="Permalink to &quot;Chromium&quot;">​</a></h3><p>支持最新特性的浏览器</p><h3 id="node-js" tabindex="-1">Node.js <a class="header-anchor" href="#node-js" aria-label="Permalink to &quot;Node.js&quot;">​</a></h3><p>javascript 运行时，可实现文件读写等功能</p><h3 id="native-apis" tabindex="-1">Native apis <a class="header-anchor" href="#native-apis" aria-label="Permalink to &quot;Native apis&quot;">​</a></h3><p>提供统一的原生界面能力</p><h2 id="electron-工作流程" tabindex="-1">Electron 工作流程 <a class="header-anchor" href="#electron-工作流程" aria-label="Permalink to &quot;Electron 工作流程&quot;">​</a></h2><p>Electron Renderer Process 通过 Main Process 调用 Native apis（Linux、MacOS、Windows）。</p><h3 id="主进程" tabindex="-1">主进程 <a class="header-anchor" href="#主进程" aria-label="Permalink to &quot;主进程&quot;">​</a></h3><p>可以看作是 package.json 中 main 属性对应的文件。</p><p>一个应用只能存在一个主进程，只有主进程可以进行 GUI 的 API 操作。</p><h3 id="渲染进程" tabindex="-1">渲染进程 <a class="header-anchor" href="#渲染进程" aria-label="Permalink to &quot;渲染进程&quot;">​</a></h3><p>windows 中展示的界面通过渲染进程表现。</p><p>一个应用可以有多个渲染进程。</p><h2 id="electron-环境搭建" tabindex="-1">Electron 环境搭建 <a class="header-anchor" href="#electron-环境搭建" aria-label="Permalink to &quot;Electron 环境搭建&quot;">​</a></h2><h3 id="官方示例" tabindex="-1">官方示例 <a class="header-anchor" href="#官方示例" aria-label="Permalink to &quot;官方示例&quot;">​</a></h3><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// 克隆示例项目仓库</span></span>
