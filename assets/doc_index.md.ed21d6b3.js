import{_ as s,o as n,c as a,Q as p}from"./chunks/framework.9bc09dc8.js";const F=JSON.parse('{"title":"JS DOC","description":"","frontmatter":{},"headers":[],"relativePath":"doc/index.md","filePath":"doc/index.md"}'),l={name:"doc/index.md"},o=p(`<h1 id="js-doc" tabindex="-1">JS DOC <a class="header-anchor" href="#js-doc" aria-label="Permalink to &quot;JS DOC&quot;">​</a></h1><p><a href="https://jsdoc.zcopy.site/" target="_blank" rel="noreferrer">JS DOC</a></p><p>增强代码可读性的注释系统（注释规范），目的是增强代码的可读性。</p><p>通过注释，可以导出一个比较规范的API文档。</p><p>vscode：Add jsdoc comments</p><h2 id="基本注释" tabindex="-1">基本注释 <a class="header-anchor" href="#基本注释" aria-label="Permalink to &quot;基本注释&quot;">​</a></h2><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">/**</span></span>
