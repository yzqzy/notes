import{_ as s,c as n,o as a,a as p}from"./app.d027aac5.js";const d=JSON.parse('{"title":"NPM","description":"","frontmatter":{},"headers":[{"level":2,"title":"Node\u6A21\u5757\u3001\u5E38\u7528\u547D\u4EE4\u3001SEMVER\u89C4\u8303","slug":"node\u6A21\u5757\u3001\u5E38\u7528\u547D\u4EE4\u3001semver\u89C4\u8303","link":"#node\u6A21\u5757\u3001\u5E38\u7528\u547D\u4EE4\u3001semver\u89C4\u8303","children":[]},{"level":2,"title":"package-lock\u3001License \u534F\u8BAE","slug":"package-lock\u3001license-\u534F\u8BAE","link":"#package-lock\u3001license-\u534F\u8BAE","children":[{"level":3,"title":"package-lock.json","slug":"package-lock-json","link":"#package-lock-json","children":[]},{"level":3,"title":"\u5F00\u6E90\u534F\u8BAE","slug":"\u5F00\u6E90\u534F\u8BAE","link":"#\u5F00\u6E90\u534F\u8BAE","children":[]}]},{"level":2,"title":"package.json \u5E38\u7528\u914D\u7F6E\u9879\u8BE6\u89E3","slug":"package-json-\u5E38\u7528\u914D\u7F6E\u9879\u8BE6\u89E3","link":"#package-json-\u5E38\u7528\u914D\u7F6E\u9879\u8BE6\u89E3","children":[]},{"level":2,"title":"scripts \u811A\u672C\u547D\u4EE4\u4EE5\u53CA\u4F7F\u7528\u6280\u5DE7","slug":"scripts-\u811A\u672C\u547D\u4EE4\u4EE5\u53CA\u4F7F\u7528\u6280\u5DE7","link":"#scripts-\u811A\u672C\u547D\u4EE4\u4EE5\u53CA\u4F7F\u7528\u6280\u5DE7","children":[]},{"level":2,"title":"dependencies\u4F9D\u8D56\u5206\u7C7B","slug":"dependencies\u4F9D\u8D56\u5206\u7C7B","link":"#dependencies\u4F9D\u8D56\u5206\u7C7B","children":[]},{"level":2,"title":"npm\u53D1\u5E03\u3001\u7248\u672C\u7BA1\u7406\u3001\u5E9F\u5F03\u4E0E\u5220\u9664","slug":"npm\u53D1\u5E03\u3001\u7248\u672C\u7BA1\u7406\u3001\u5E9F\u5F03\u4E0E\u5220\u9664","link":"#npm\u53D1\u5E03\u3001\u7248\u672C\u7BA1\u7406\u3001\u5E9F\u5F03\u4E0E\u5220\u9664","children":[]},{"level":2,"title":"\u7F16\u5199 markdown \u6587\u6863","slug":"\u7F16\u5199-markdown-\u6587\u6863","link":"#\u7F16\u5199-markdown-\u6587\u6863","children":[]}],"relativePath":"npm/base/index.md"}'),l={name:"npm/base/index.md"},e=p(`<h1 id="npm" tabindex="-1">NPM <a class="header-anchor" href="#npm" aria-hidden="true">#</a></h1><h2 id="node\u6A21\u5757\u3001\u5E38\u7528\u547D\u4EE4\u3001semver\u89C4\u8303" tabindex="-1">Node\u6A21\u5757\u3001\u5E38\u7528\u547D\u4EE4\u3001SEMVER\u89C4\u8303 <a class="header-anchor" href="#node\u6A21\u5757\u3001\u5E38\u7528\u547D\u4EE4\u3001semver\u89C4\u8303" aria-hidden="true">#</a></h2><p>Node\u6A21\u5757\uFF08mode_modules\uFF09</p><p>Node\u73AF\u5883\uFF1A\u4E00\u4E2A\u5728Node\u73AF\u5883\u4E0B\u5F00\u53D1\u7684\u9879\u76EE\uFF0C\u6A21\u5757\u53EF\u80FD\u662F\u4E00\u4E2A\u5E93\u3001\u6846\u67B6\u6216\u8005\u662F\u9879\u76EE\u4F9D\u8D56\u3001\u751A\u81F3\u662F\u4E00\u4E2A\u9879\u76EE\uFF0CNode\u73AF\u5883\u5C31\u662F\u8BA9\u8FD9\u4E9B\u6A21\u5757\u6210\u529F\u8FD0\u884C\u8D77\u6765\u7684\u670D\u52A1\u63D0\u4F9B\u65B9\u3002</p><p>package.json\uFF1A\u63CF\u8FF0node\u6A21\u5757\u7684\u6587\u4EF6\uFF0C\u5305\u542B\u591A\u9879\u5BF9Node\u6A21\u5757\u7684\u8BF4\u660E\u4E0E\u914D\u7F6E\u3002</p><div class="language-js"><button class="copy"></button><span class="lang">js</span><pre><code><span class="line"><span style="color:#A6ACCD;">npm init </span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#A6ACCD;">npm rebuild xxx </span><span style="color:#676E95;">// \u91CD\u65B0\u6784\u5EFA\u6A21\u5757</span></span>
<span class="line"></span>
<span class="line"><span style="color:#A6ACCD;">npm update xxxx or npm update </span><span style="color:#89DDFF;">-</span><span style="color:#A6ACCD;">g xxx </span><span style="color:#676E95;">// \u66F4\u65B0\u6A21\u5757</span></span>
<span class="line"></span>
<span class="line"><span style="color:#A6ACCD;">npm search xxx </span><span style="color:#676E95;">// \u641C\u7D22\u6A21\u5757</span></span>
...
</code></pre><div class="language-"><button class="copy"></button><span class="lang"></span><pre><code><span class="line"><span style="color:#A6ACCD;">1.3.2-20200507_alpha</span></span>
...
&gt; 3.2   &lt; 2.2   2.0.3-2.1.0        
</code></pre><div class="language-js"><button class="copy"></button><span class="lang">js</span><pre><code><span class="line"><span style="color:#89DDFF;">||</span><span style="color:#A6ACCD;">\uFF1A\u6216\u9009\u62E9</span></span>
<span class="line"></span>
...
*\uFF1A\u6240\u6709\u7248\u672C\u53F7
</code></pre><div class="language-"><button class="copy"></button><span class="lang"></span><pre><code><span class="line"><span style="color:#A6ACCD;">0.1.0_base</span></span>
...
</code></pre><div class="language-"><button class="copy"></button><span class="lang"></span><pre><code><span class="line"><span style="color:#A6ACCD;">&quot;remove&quot;: &quot;rm -rf index.txt&quot;</span></span>
...
\u6BD4\u5982\u4E34\u65F6\u6587\u4EF6\u7B49\u3002
</code></pre><p>\u53C2\u6570</p><div class="language-js"><button class="copy"></button><span class="lang">js</span><pre><code><span class="line"><span style="color:#89DDFF;">&quot;</span><span style="color:#C3E88D;">build</span><span style="color:#89DDFF;">&quot;</span><span style="color:#A6ACCD;">: </span><span style="color:#89DDFF;">&quot;</span><span style="color:#C3E88D;">webpack --config wepack.config.js &amp;&amp; node upload_source.js</span><span style="color:#89DDFF;">&quot;</span></span>
<span class="line"></span>
<span class="line"><span style="color:#676E95;">// --config \u5C31\u662F\u914D\u7F6E\u7684\u53C2\u6570</span></span>
...
</code></pre><p>\u94A9\u5B50</p><div class="language-"><button class="copy"></button><span class="lang"></span><pre><code><span class="line"><span style="color:#A6ACCD;">&quot;prebuild&quot;: &quot;echo before&quot;,</span></span>
...
</code></pre><p>\u53D6\u503C</p><div class="language-json"><button class="copy"></button><span class="lang">json</span><pre><code><span class="line"><span style="color:#A6ACCD;">p<wbr>rocess.env.npm_package_name</span></span>
<span class="line"><span style="color:#A6ACCD;">p<wbr>rocess.env.npm_package_repository_type</span></span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"><span style="color:#A6ACCD;">p<wbr>rocess.env.npm_package_server_port; </span><span style="color:#676E95;">// 3000</span></span>
...
</code></pre><p>npm i xxx \u5B89\u88C5\u5F53\u524D\u547D\u4EE4\u884C\u6240\u5728\u76EE\u5F55\u3001\u5B89\u88C5\u5728dependenices</p><p>npm i xxx -g \u5168\u5C40\u5B89\u88C5</p><p>peerDependencies</p><p>peerDependencies\uFF1A\u540C\u8F88\u4F9D\u8D56</p><div class="language-"><button class="copy"></button><span class="lang"></span><pre><code><span class="line"><span style="color:#A6ACCD;">test \u9879\u76EE\u4E2D\u4F9D\u8D56 a\u3001b \u6A21\u5757\uFF0Ca \u6A21\u5757\u4E5F\u4F9D\u8D56 b \u6A21\u5757\uFF0C\u5982\u4F55\u89E3\u51B3\u4E0D\u91CD\u590D\u5B89\u88C5 b \u6A21\u5757\u3002</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"></span></code></pre></div><p>\u5220\u9664\u5305</p><p>\u5305\u5220\u9664 24 \u5C0F\u65F6\u540E\u53EF\u91CD\u53D1 \u53D1\u5E03 72 \u5C0F\u65F6\u5185\u7684\u5305\u53EF\u5220\u9664</p><div class="language-js"><button class="copy"></button><span class="lang">js</span><pre><code><span class="line"><span style="color:#A6ACCD;">npm unpublish yeuluo</span><span style="color:#89DDFF;">-</span><span style="color:#A6ACCD;">first@</span><span style="color:#F78C6C;">0.1</span><span style="color:#89DDFF;">.</span><span style="color:#F78C6C;">0</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">-</span><span style="color:#A6ACCD;">force</span></span>
<span class="line"></span></code></pre></div><p>\u5220\u9664\u5305</p><div class="language-js"><button class="copy"></button><span class="lang">js</span><pre><code><span class="line"><span style="color:#A6ACCD;">npm unpublish yeuluo</span><span style="color:#89DDFF;">-</span><span style="color:#A6ACCD;">first </span><span style="color:#89DDFF;">-</span><span style="color:#A6ACCD;">force</span></span>
<span class="line"></span></code></pre></div><h2 id="\u7F16\u5199-markdown-\u6587\u6863" tabindex="-1">\u7F16\u5199 markdown \u6587\u6863 <a class="header-anchor" href="#\u7F16\u5199-markdown-\u6587\u6863" aria-hidden="true">#</a></h2><p>markdown</p><p>\u7EAF\u6587\u672C\u683C\u5F0F\u6807\u8BB0\u8BED\u8A00\uFF0C\u672C\u8D28\u4E0A\u8DDFHTML\u4E00\u81F4\uFF0C\u6CA1\u6709\u533A\u522B\u3002</p><p>\u7528\u7B80\u5355\u7684\u4E66\u5199\u65B9\u5F0F\u786E\u5B9A\u4E00\u6279\u6587\u672C\u663E\u793A\u683C\u5F0F\u3002</p><p>\u540E\u7F00\u540D\uFF1A.md</p><p>vscode Markdown Preview Enhanced</p><p>\u6807\u9898</p><div class="language-html"><button class="copy"></button><span class="lang">html</span><pre><code><span class="line"><span style="color:#A6ACCD;"># Thi is a title for markdon</span></span>
<span class="line"><span style="color:#A6ACCD;">## Thi is a title for markdon</span></span>
<span class="line"><span style="color:#A6ACCD;">### Thi is a title for markdon</span></span>
<span class="line"><span style="color:#A6ACCD;">#### Thi is a title for markdon</span></span>
<span class="line"><span style="color:#A6ACCD;">##### Thi is a title for markdon</span></span>
<span class="line"><span style="color:#A6ACCD;">###### Thi is a title for markdon</span></span>
<span class="line"></span></code></pre></div><p>\u6587\u672C</p><div class="language-html"><button class="copy"></button><span class="lang">html</span><pre><code><span class="line"><span style="color:#A6ACCD;">This is a content for markdown.</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div><p>\u5F15\u7528</p><div class="language-html"><button class="copy"></button><span class="lang">html</span><pre><code><span class="line"><span style="color:#A6ACCD;">&gt; This is a content.</span></span>
<span class="line"><span style="color:#A6ACCD;">&gt; &gt; This is a content.</span></span>
<span class="line"><span style="color:#A6ACCD;">&gt; &gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">&gt; &gt; &gt; This is a content.</span></span>
<span class="line"><span style="color:#A6ACCD;">&gt; &gt; &gt; </span></span>
<span class="line"></span></code></pre></div><p>\u5206\u5272\u7EBF</p><div class="language-html"><button class="copy"></button><span class="lang">html</span><pre><code><span class="line"><span style="color:#A6ACCD;">---</span></span>
<span class="line"></span></code></pre></div><hr><p>\u56FE\u7247</p><div class="language-html"><button class="copy"></button><span class="lang">html</span><pre><code><span class="line"><span style="color:#A6ACCD;">![yueluo](http://data.yueluo.club/icon/icon.png &quot;yueluo&quot;)</span></span>
<span class="line"></span></code></pre></div><p>\u8D85\u94FE\u63A5</p><div class="language-html"><button class="copy"></button><span class="lang">html</span><pre><code><span class="line"><span style="color:#A6ACCD;">[yueluo](http://www.yueluo.club &quot;yueluo&quot;)</span></span>
<span class="line"></span></code></pre></div><p>\u65E0\u5E8F\u5217\u8868</p><div class="language-html"><button class="copy"></button><span class="lang">html</span><pre><code><span class="line"><span style="color:#A6ACCD;">\u65E0\u5E8F - + *</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#A6ACCD;">* list item</span></span>
<span class="line"><span style="color:#A6ACCD;">+ list item</span></span>
<span class="line"></span></code></pre></div><p>\u6709\u5E8F\u5217\u8868</p><div class="language-html"><button class="copy"></button><span class="lang">html</span><pre><code><span class="line"><span style="color:#A6ACCD;">this is a list</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div><p>\u5217\u8868\u5D4C\u5957</p><div class="language-html"><button class="copy"></button><span class="lang">html</span><pre><code><span class="line"><span style="color:#A6ACCD;">this is a list</span></span>
<span class="line"></span>
<span class="line"><span style="color:#A6ACCD;">  - list item</span></span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"><span style="color:#A6ACCD;">  + list item</span></span>
<span class="line"></span></code></pre></div><p>\u8868\u683C</p><div class="language-html"><button class="copy"></button><span class="lang">html</span><pre><code><span class="line"><span style="color:#A6ACCD;">th|th|th|th</span></span>
<span class="line"><span style="color:#A6ACCD;">:-:|:-:|:-:|:-:</span></span>
...
<span class="line"><span style="color:#89DDFF;">}</span></span>
<span class="line"></span></code></pre></div><div class="language-css"><button class="copy"></button><span class="lang">css</span><pre><code><span class="line"><span style="color:#89DDFF;">#</span><span style="color:#F78C6C;">app</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">{</span></span>
...
<span class="line"></span></code></pre></div><p>\u6D41\u7A0B\u56FE <code>flow content</code></p><div class="language-html"><button class="copy"></button><span class="lang">html</span><pre><code><span class="line"><span style="color:#A6ACCD;">cond1=&gt;condition: \u4FEE\u6539\u6E90\u7801\u540E\u95ED\u6E90\uFF1F</span></span>
...
<span class="line"></span></code></pre></div>`,170),o=[e];function c(t,r,i,y,D,C){return a(),n("div",null,o)}const u=s(l,[["render",c]]);export{d as __pageData,u as default};
