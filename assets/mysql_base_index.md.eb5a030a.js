...
<span class="line"><span style="color:#e1e4e8;">+---------------------+------------+-----------+----------+------------+</span></span>
<span class="line"><span style="color:#e1e4e8;">| 2020-12-01 00:00:00 | 1 | 本 | 1.000 | 89.00 |</span></span>
<span class="line"><span style="color:#e1e4e8;">| 2020-12-01 00:00:00 | 2 | 笔 | 1.000 | 5.00 |</span></span>
<span class="line"><span style="color:#e1e4e8;">| 2020-12-02 00:00:00 | 3 | 胶水 | 2.000 | 20.00 |</span></span>
<span class="line"><span style="color:#e1e4e8;">+---------------------+------------+-----------+----------+------------+</span></span>
<span class="line"><span style="color:#e1e4e8;">3 rows in set (0.00 sec)</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">mysql&gt; SELECT</span></span>
<span class="line"><span style="color:#24292e;">-&gt; a.transdate,</span></span>
<span class="line"><span style="color:#24292e;">-&gt; a.itemnumber,</span></span>
...
<span class="line"><span style="color:#24292e;">+---------------------+------------+-----------+----------+------------+</span></span>
<span class="line"><span style="color:#24292e;">| 2020-12-01 00:00:00 | 1 | 本 | 1.000 | 89.00 |</span></span>
<span class="line"><span style="color:#24292e;">| 2020-12-01 00:00:00 | 2 | 笔 | 1.000 | 5.00 |</span></span>
<span class="line"><span style="color:#24292e;">| 2020-12-02 00:00:00 | 3 | 胶水 | 2.000 | 20.00 |</span></span>
<span class="line"><span style="color:#24292e;">+---------------------+------------+-----------+----------+------------+</span></span>
<span class="line"><span style="color:#24292e;">3 rows in set (0.00 sec)</span></span></code></pre></div><p>在实际项目中，我们发现，每日商品销售查询使用的频次很高，而且经常需要以这个查询的结果为基础，进行更进一步的统计。</p><p>举个例子，超市经营者要查一下“每天商品的销售数量和当天库存数量的对比”，如果用一个 SQL 语句查询，就会比较复杂。历史库存表（demo.inventoryhist）如下所示：</p>`,1038),k=[O];function I(M,D,U,F,_,f){return n(),a("div",null,k)}const w=s(C,[["render",I]]);export{B as __pageData,w as default};
